...
# Unit tests for DockGeniusApiRubyClient::Customer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Customer' do
  before do
    # run before each test
    @instance = DockGeniusApiRubyClient::Customer.new
  end
  ...
  describe 'test an instance of Customer' do
    it 'should create an instact of Customer' do
      expect(@instance).to be_instance_of(DockGeniusApiRubyClient::Customer)
    end
  end
